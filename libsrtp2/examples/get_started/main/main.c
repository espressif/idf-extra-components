 ...
 *
 * Minimal sanity-check app for libsrtp2: initializes and shuts down libsrtp.
...
static const char *TAG = "libsrtp2_check";
...
void app_main(void)
{
    ...
    srtp_shutdown();
    ESP_LOGI(TAG, "libsrtp2 build check complete");
}
