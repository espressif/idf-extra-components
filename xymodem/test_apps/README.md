...
The console UART (usually UART0) is left untouched. The default ports are UART1 and UART2, which means the target needs at least three UART controllers (for example ESP32 or ESP32-S3).
