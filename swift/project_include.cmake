...
# Add swift language installed check: ensure swiftc is available before enable_language(Swift)
if(NOT DEFINED CMAKE_Swift_COMPILER)
    ...
    if(NOT CMAKE_Swift_COMPILER)
        message(FATAL_ERROR "Swift compiler (swiftc) not found. "
            "Please install the Embedded Swift toolchain and ensure swiftc is in PATH. "
            "OR set CMAKE_Swift_COMPILER to the compiler path.")
    endif()
    message(STATUS "Swift: Using compiler ${CMAKE_Swift_COMPILER}")
endif()
