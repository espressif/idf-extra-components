...
commit. Espressif may apply patches to this tree (for example hardening and bug fixes listed in
[CHANGELOG.md](CHANGELOG.md)). See [VENDORED_UPSTREAM.md](VENDORED_UPSTREAM.md) for the baseline
commit SHA and the procedure for refreshing against upstream.
