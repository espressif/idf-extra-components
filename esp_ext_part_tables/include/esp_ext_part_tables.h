...
typedef struct {
    ...
    void* extra; /*!< Extra information (e.g. LittleFS block size stored in CHS hack, etc.) */
    char* label;
 ...
 *
 * @return Number of sectors or 0 if the sector size is unknown to avoid a divison by zero.
 */
