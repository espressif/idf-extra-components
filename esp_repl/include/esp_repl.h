 ...
 */
typedef void (*esp_repl_on_stop_fn)(void *ctx, esp_repl_instance_handle_t handle);
 ...
 * @param handle Handle to the REPL instance.
 */
typedef void (*esp_repl_on_exit_fn)(void *ctx, esp_repl_instance_handle_t handle);
