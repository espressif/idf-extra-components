...
/**
 * @brief Transmit data over a RMT UART controller. This is a non-blocking function.
 *
...
/**
 * @brief Receive data over a RMT UART controller. This is a non-blocking function.
 *
