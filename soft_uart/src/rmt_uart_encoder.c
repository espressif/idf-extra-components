...
esp_err_t rmt_new_uart_encoder(const rmt_uart_config_t *config, rmt_encoder_handle_t *ret_encoder)
{
    esp_err_t ret = ESP_OK;
    rmt_uart_encoder_t *uart_encoder = NULL;
    ESP_GOTO_ON_FALSE(config && ret_encoder, ESP_ERR_INVALID_ARG, err, TAG, "invalid argument");
    uart_encoder = rmt_alloc_encoder_mem(sizeof(rmt_uart_encoder_t));
