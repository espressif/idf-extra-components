...
void app_main(void)
{
    ...
    esp_cli_command_t debug_cmd = {
        debug_cmd.name = "debug",
        debug_cmd.group = "example",
        debug_cmd.help = "Prints debug information",
        debug_cmd.func = debug_cmd_handler,
        debug_cmd.func_ctx = NULL,
        debug_cmd.hint_cb = debug_cmd_hint_cb,
        debug_cmd.glossary_cb = debug_cmd_glossary_cb
    };
    ...
    esp_cli_command_t unregister_cmd = {
        unregister_cmd.name = "unregister",
        unregister_cmd.group = "example",
        unregister_cmd.help = "Unregisters a command by name",
        unregister_cmd.func = unregister_cmd_handler,
        unregister_cmd.func_ctx = NULL,
        unregister_cmd.hint_cb = unregister_cmd_hint_cb,
        unregister_cmd.glossary_cb = unregister_cmd_glossary_cb
    };
